        ...
        {currentView.type === 'artifact' && selectedArtifact ? (
          ...
          folderArtifacts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center">
              <div className="relative">
                ...
                <FolderOpen className="w-16 h-16 text-zinc-700 relative" />
              </div>
              <h3
                className="mt-4 text-lg font-medium text-zinc-400"
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            <div className="relative">
              ...
              <FolderOpen className="w-16 h-16 text-zinc-600 relative" />
            </div>
            <h3
              className="mt-4 text-lg font-medium text-zinc-400"
              style={{ fontFamily: 'Space Grotesk, sans-serif' }}
