...
export function SetupWizard({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-950">
      {/* Header */}
      <header className="sticky top-0 z-10 backdrop-blur-lg bg-white/80 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-800">
      ...
      {/* Footer navigation */}
      <footer className="sticky bottom-0 backdrop-blur-lg bg-white/80 dark:bg-zinc-900/80 border-t border-zinc-200 dark:border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
