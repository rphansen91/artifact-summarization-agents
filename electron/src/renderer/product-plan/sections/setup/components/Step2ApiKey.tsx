  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-3">
        ...
        >
          Your Mastra API key enables AI-powered analysis and contextualization of your artifacts.
        </p>
      </div>
      ...
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <div className="text-center">
          <a
            ...
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            Don't have an API key? Get one from Mastra
      ...
      <div className="max-w-lg mx-auto p-4 rounded-xl bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700">
        ...
        >
          ...
          It never leaves your machine and is only used to communicate with Mastra's API for artifact analysis.
        </p>
      </div>
    </div>
  )
