    ...
    return (
      ...
      >
        ...
        <div className="w-16 h-12 rounded-md bg-zinc-200 dark:bg-zinc-900 overflow-hidden flex-shrink-0 border border-zinc-300 dark:border-zinc-700">
          ...
          <div className={`w-full h-full flex items-center justify-center bg-gradient-to-br from-zinc-200 to-zinc-300 dark:from-zinc-800 dark:to-zinc-900 ${artifact.imagePath ? 'hidden' : ''}`}>
            <FileImage className="w-5 h-5 text-zinc-400 dark:text-zinc-600" />
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <h3
            className="text-sm font-medium text-zinc-800 dark:text-zinc-200 truncate group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors"
